...
import {AddPhotoMenuList} from './SettingListData';
import textStyle from 'theme/typoGraphy';
import ProvidersList from './ProvidersList';
import AddPhotoMenuLists from './AddPhotoMenuList';
...
export default PhotoMenuBottomSheet;
