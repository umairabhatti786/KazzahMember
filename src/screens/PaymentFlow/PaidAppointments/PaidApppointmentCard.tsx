...
const PaidAppointmentCard = (props: any) => {
  const navigation = useNavigation();
  const {colors} = useTheme();
  const styles = makeStyles(colors);
  const dispatch=useDispatch()
  console.log('totalDuration', props.item?.id);
    ...
    <TouchableOpacity
      ...
      <View
        ...
        <View
          ...
          <Button height={verticalScale(30)} label="Rebook" width={'30%'} />
        </View>
      </View>
      ...
      <View   style={{height:"62%"}}>
        ...
        <View style={styles.detailContainer}>
          ...
          <Text numberOfLines={1} style={[textStyle.b4, {color: colors.black}]}>
            {`$${Number(props.item?.grandTotal).toFixed(2)}`}
          </Text>
        </View>
...
export default PaidAppointmentCard;
