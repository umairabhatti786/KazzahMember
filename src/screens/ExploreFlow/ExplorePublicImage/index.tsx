...
import {getPublicProviderMedia} from 'reducers/searchReducer';
import PhotoMenuBottom from '../PhotoMenuBottom';
const TempPhoto = require('../../../../src/assets/temporaryLIstImage.png');

const ExplorePublicImage = () => {
  const PhotoListCardData = useSelector(getPublicProviderMedia);
...
export default ExplorePublicImage;
